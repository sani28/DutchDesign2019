...
var targetDivs = document.querySelectorAll('.archive-stack');

for (var i = 0; i < targetDivs.length; i++) {

  $("#ten").hover(function() {
      $("#ten").css("background-image", "url(./imgs/legacyphotos/2010.png)");
  ...
  $("#eleven").hover(function() {
      $("#eleven").css("background-image", "url(./imgs/legacyphotos/2011.png)");
  ...
  $("#twelve").hover(function() {
      $("#twelve").css("background-image", "url(./imgs/legacyphotos/2012.png)");
  ...
  $("#thirteen").hover(function() {
      $("#thirteen").css("background-image", "url(./imgs/legacyphotos/2013.png)");
  ...
  $("#fourteen").hover(function() {
      $("#fourteen").css("background-image", "url(./imgs/legacyphotos/2014.png");
  ...
  $("#fifteen").hover(function() {
      $("#fifteen").css("background-image", "url(./imgs/legacyphotos/2015.png)");
  ...
  $("#sixteen").hover(function() {
      $("#sixteen").css("background-image", "url(./imgs/legacyphotos/2016.png)");
  ...
  $("#seventeen").hover(function() {
      $("#seventeen").css("background-image", "url(./imgs/legacyphotos/2017.svg)");
  ...
  $("#eighteen").hover(function() {
      $("#eighteen").css("background-image", "url(./imgs/legacyphotos/2018.png)");
  ...
  $("#nineteen").hover(function() {
      $("#nineteen").css("background-image", "url(./legacyphotos/2019.png)");
    },
    function() {
  ...
  // Vertical -> Horizontal Scroll Mapping
  $(function() {
